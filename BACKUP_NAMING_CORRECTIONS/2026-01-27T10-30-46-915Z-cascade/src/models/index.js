...
Compagnie.hasMany(JournalEntry, { foreignKey: 'company_id' });
JournalEntry.belongsTo(Compagnie, { foreignKey: 'company_id' });
...
Compagnie.hasMany(FiscalYear, { foreignKey: 'company_id', as: 'fiscalYears' });
FiscalYear.belongsTo(Compagnie, { foreignKey: 'company_id', as: 'company' });
