 ...
 */
import { createBaseCommand, } from '../../domain/commands';
// ═══════════════════════════════════════════════════════════════════════════
// ID GENERATORS
// ═══════════════════════════════════════════════════════════════════════════
...
export function toUpdateRenewalInfoCommand(dto) {
    const base = createBaseCommand(dto.tenantId, dto.actorId);
    return {
        ...base,
...
export function toAllocateAssetCommand(dto) {
    const base = createBaseCommand(dto.tenantId, dto.actorId);
    return {
        ...base,
...
export function toRecordDepreciationCommand(dto) {
    const base = createBaseCommand(dto.tenantId, dto.actorId);
    return {
        ...base,
...
export function toCalculateDepreciationsCommand(dto) {
    const base = createBaseCommand(dto.tenantId, dto.actorId);
    return {
        ...base,
...
export function toRecordMaintenanceCommand(dto) {
    const base = createBaseCommand(dto.tenantId, dto.actorId);
    return {
        ...base,
...
export function toDisposeAssetCommand(dto) {
    const base = createBaseCommand(dto.tenantId, dto.actorId);
    return {
        ...base,
        type: 'DisposeAsset',
...
export function toDecommissionAssetCommand(dto) {
    const base = createBaseCommand(dto.tenantId, dto.actorId);
    return {
        ...base,
...
// ═══════════════════════════════════════════════════════════════════════════
export function toAssetCreatedEventDTO(event) {
    return {
...
export function toRenewalInfoUpdatedEventDTO(event) {
    return {
        eventId: event.eventId,
...
export function toAssetDisposedEventDTO(event) {
    return {
        eventId: event.eventId,
        type: 'AssetDisposed',
        tenantId: event.tenantId,
...
export function toAssetDecommissionedEventDTO(event) {
    return {
        eventId: event.eventId,
...
export function toDepreciationRecordedEventDTO(event) {
    return {
        eventId: event.eventId,
...
export function toMaintenanceRecordedEventDTO(event) {
    return {
        eventId: event.eventId,
