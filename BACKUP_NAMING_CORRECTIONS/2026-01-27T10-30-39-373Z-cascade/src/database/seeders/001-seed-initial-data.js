...
import { User, Compagnie, ChartOfAccount } from '../../models/index.js';
...
export const seedInitialData = async () => {
  try {
    ...
    let testCompany = await Compagnie.findOne({ where: { registrationNumber: 'TEST-001' } });
    if (!testCompany) {
      testCompany = await Compagnie.create({
        name: 'SPOFE Test Compagnie',
