...
class ApprovalsController {
  ...
  static async getStats(req, res) {
    try {
      ...
      logger.info('Approval stats retrieved', { userId, stats });
  ...
  static async getPendingApprovals(req, res) {
    try {
      ...
      logger.info('Pending approvals retrieved', { userId: req.user?.id, count: approvals.length });
  ...
  static async requestChanges(req, res) {
    try {
      ...
      `, {
        replacements: [id, userId, changes]
      });

      logger.info('Changes requested', { approvalId: id, userId });
  ...
  static async getAuditLogs(req, res) {
    try {
      ...
      logger.info('Audit logs retrieved', { userId: req.user?.id, count: logs.length });
  ...
  static async getStatusBreakdown(req, res) {
    try {
      ...
      logger.info('Status breakdown retrieved', { userId: req.user?.id });
