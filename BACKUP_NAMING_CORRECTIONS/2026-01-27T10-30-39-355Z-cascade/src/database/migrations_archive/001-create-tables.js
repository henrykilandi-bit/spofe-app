...
export default {
  up: async (queryInterface, Sequelize) => {
    try {
      ...
      await queryInterface.addIndex('ChartOfAccounts', ['companyId', 'accountNumber'], {
      ...
      await queryInterface.addIndex('JournalEntries', ['companyId']);
      ...
      await queryInterface.addIndex('AccountBalances', ['companyId', 'accountId', 'fiscalYear', 'monthNumber'], {
