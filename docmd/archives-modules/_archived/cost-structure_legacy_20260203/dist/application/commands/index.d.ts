...
export type CostStructureCommand = import('./create-economic-project.command.js').CreateEconomicProjectCommand | import('./create-cost-structure.command.js').CreateCostStructureCommand | import('./add-cost-line.command.js').AddCostLineCommand | import('./update-assumptions.command.js').UpdateAssumptionsCommand | import('./run-simulation.command.js').RunSimulationCommand | import('./freeze-cost-structure.command.js').FreezeCostStructureCommand | import('./validate-project.command.js').ValidateProjectCommand | import('./reject-project.command.js').RejectProjectCommand;
