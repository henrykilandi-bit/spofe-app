...
exports.InMemoryDecisionRecordRepository = exports.PostgresDecisionRecordRepository = void 0;
// ─────────────────────────────────────────────────────────────
// PostgreSQL Implementation
// ─────────────────────────────────────────────────────────────
class PostgresDecisionRecordRepository {
    constructor(pool) {
        this.pool = pool;
    }
    /**
     ...
     */
    async findLatestForProject(tenantId, projectId) {
    ...
    async saveEvents(events) {
        const decisionEvents = events.filter(e => e.eventType === 'DecisionRecorded');
        ...
        try {
           ...
           ON CONFLICT (event_id) DO NOTHING`, [
                ...
                await client.query(`INSERT INTO coutflex.decision_records 
...
exports.PostgresDecisionRecordRepository = PostgresDecisionRecordRepository;
// ─────────────────────────────────────────────────────────────
// In-Memory Implementation (Tests)
// ─────────────────────────────────────────────────────────────
class InMemoryDecisionRecordRepository {
    constructor() {
...
exports.InMemoryDecisionRecordRepository = InMemoryDecisionRecordRepository;
