 ...
 */
import { ProjectType, CostCategory } from './value-objects';
export type CostStructureEvent = EconomicProjectCreated | CostStructureCreated | CostLineAdded | AssumptionsUpdated | CostStructureSimulated | CostStructureFrozen | ProjectValidated | ProjectRejected;
/**
