import { ChartOfAccount, JournalEntry, JournalEntryLine, Company, ThirdParty, sequelize } from '../models/index.js';
 ...
 * @param {Object} req - Requête Express (query: companyId, startDate, endDate, level)
 * @param {Object} res - Réponse Express
 */
export const getBalance = async (req, res) => {
  try {
    const { companyId, startDate, endDate, level } = req.query;
    ...
    const accountWhere = { companyId: parseInt(companyId), isActive: true };
    if (level) {
 ...
 * @param {Object} req - Requête Express (query: companyId, startDate, endDate, thirdPartyType)
 * @param {Object} res - Réponse Express
 */
export const getBalanceAuxiliary = async (req, res) => {
  try {
    const { companyId, startDate, endDate, thirdPartyType } = req.query;
    ...
    const thirdPartyWhere = { companyId: parseInt(companyId), isActive: true };
    if (thirdPartyType) {
    ...
    const queryFilters = [];
    const replacements = { companyId: parseInt(companyId) };
 ...
 * @param {Object} req - Requête Express (query: companyId, accountId, startDate, endDate)
 * @param {Object} res - Réponse Express
 */
 ...
 * @param {Object} req - Requête Express (query: companyId, fiscalYear ou startDate+endDate)
 * @param {Object} res - Réponse Express
 */
export const getIncomeStatement = async (req, res) => {
  try {
    const { companyId, fiscalYear, startDate, endDate } = req.query;
 ...
 * @param {Object} req - Requête Express (query: companyId, date)
 * @param {Object} res - Réponse Express
 */
