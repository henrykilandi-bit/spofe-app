    ...
    switch (formData.role) {
      ...
      case 'utilisateur':
        if (!formData.groupeId) {
          newErrors.groupeId = 'Veuillez sélectionner un groupe';
        }
