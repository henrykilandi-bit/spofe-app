...
- Statut de période : OPEN | CLOSED | LOCKED
- Périodicités autorisées : mensuelle | trimestrielle | annuelle
...
- Formats normés de numérotation : pièces | écritures | journaux
...
- Typologies de coûts reconnues : direct | indirect | amorti

📌 Paramètres définit ce qui est autorisé, pas comment c'est appliqué.

### 6️⃣ États & Statuts Normés Transverses

- États génériques reconnus : DRAFT | VALIDATED | CLOSED | LOCKED
...
- Capacités associées : READ | WRITE | CLOSE | EXPORT
...
- Libellé
- Catégorie : commercial | logistique | financier | administratif
...
- Statut du cadre : ACTIVE | DEPRECATED
