...
let DisposeAssetHandler = class DisposeAssetHandler {
    guardian;
    repository;
    ...
    async execute(command) {
        ...
        const calculation = this.guardian.calculateDisposal(state.asset, state.depreciation, command.disposalValue, new Date(command.disposalDate));
        // 4️⃣ GENERATE EVENT
...
DisposeAssetHandler = __decorate([
    Injectable(),
...
export { DisposeAssetHandler };
//# sourceMappingURL=dispose-asset.handler.js.map