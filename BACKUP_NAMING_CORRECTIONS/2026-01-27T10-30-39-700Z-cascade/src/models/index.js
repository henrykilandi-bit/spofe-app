...
import AppSetting from './appSettings.model.js';
...
Compagnie.hasMany(JournalEntry, { foreignKey: 'companyId', as: 'entries' });
JournalEntry.belongsTo(Compagnie, { foreignKey: 'companyId', as: 'company' });

Compagnie.hasMany(ChartOfAccount, { foreignKey: 'companyId', as: 'chartsOfAccounts' });
ChartOfAccount.belongsTo(Compagnie, { foreignKey: 'companyId', as: 'company' });
...
Compagnie.hasMany(ThirdParty, { foreignKey: 'companyId' });
ThirdParty.belongsTo(Compagnie, { foreignKey: 'companyId' });
...
// User.hasMany(JournalEntry, { foreignKey: 'userId', as: 'entriesCreated' });
...
// JournalEntry.belongsTo(User, { foreignKey: 'userId', as: 'creator' });
...
// FiscalYear → Compagnie & BusinessOperation
Compagnie.hasMany(FiscalYear, { foreignKey: 'companyId', as: 'fiscalYears' });
FiscalYear.belongsTo(Compagnie, { foreignKey: 'companyId', as: 'company' });
...
JournalEntry.belongsTo(User, { foreignKey: 'userId', as: 'createdBy', constraints: false });
...
export { 
  ...
  User, 
  Compagnie,
  Compagnie as Compagnie, // Alias for backward compatibility
  ChartOfAccount, 
  JournalEntry, 
  JournalEntryLine, 
  AccountBalance,
