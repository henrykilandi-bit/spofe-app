...
import { ImmobilisationEvent, MaintenanceRecordedEvent, createBaseEvent } from './events';
import { MaintenanceInvariants, SecurityInvariants } from './invariants';

// ═══════════════════════════════════════════════════════════════════════════
// MAINTENANCE RECORD AGGREGATE
// ═══════════════════════════════════════════════════════════════════════════
...
export class MaintenanceRecord {
  ...
  static record(params: {
    ...
    actorId: string;
  }): { aggregate: MaintenanceRecord; events: ImmobilisationEvent[] } {
    ...
    const aggregate = new MaintenanceRecord(
    ...
    const event: MaintenanceRecordedEvent = {
...
export class MaintenanceAggregator {
   ...
   */
  static calculateCostByType(
    records: MaintenanceRecord[]
  ): Record<MaintenanceType, Money> {
