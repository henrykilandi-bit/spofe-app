...
const ChartOfAccounts = () => {
  ...
  const fetchAccounts = useCallback(async () => {
    try {
      ...
      const url = `${API_BASE}/chart-of-accounts?company_id=${company_id}`;
                  ...
                  <td style={{ ...tdStyle, textAlign: "center" }}>
                    <span
                      style={{
                        ...
                        borderRadius: "6px",
                        fontWeight: "bold",
                        backgroundColor: acc.is_active ? "#d1e7dd" : "#f8d7da",
                        color: acc.is_active ? "#0f5132" : "#842029",
                      }}
                    >
