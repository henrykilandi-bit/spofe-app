/**
 * 📋 DTO CompanyPermission - Généré automatiquement depuis company_permissions
 * 
 * @generated 2026-01-27T15:57:32.795Z
 * @source MySQL Table: company_permissions
 * @description DTO pour la table company_permissions
 * @priority MEDIUM
 * @version SPOFE v2.2
 */
...
class CompanyPermissionDTO {
  ...
  static fromDatabase(dbRow) {
    return new CompanyPermissionDTO({
      id: dbRow.id,
  ...
  static fromAPI(apiData) {
    ...
    return new CompanyPermissionDTO(dbData);
  }
...
// Export du DTO
module.exports = CompanyPermissionDTO;

// Export des métadonnées
module.exports.schema = CompanyPermissionDTO.getSchema();
module.exports.metadata = CompanyPermissionDTO.getMetadata();
module.exports.properties = 'id', 'user_id', 'compagnie_id', 'permission', 'granted_by', 'granted_at', 'expires_at', 'is_active';
module.exports.relationships = 'users', 'compagnies';

// Export des méthodes utilitaires
module.exports.fromDatabase = CompanyPermissionDTO.fromDatabase;
module.exports.fromAPI = CompanyPermissionDTO.fromAPI;
module.exports.getExample = CompanyPermissionDTO.getExample;
