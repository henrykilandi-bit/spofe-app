...
import { User, GroupeEntreprise, Company } from '../models/index.js';
...
export const register = async (req, res, next) => {
    try {
        ...
        if (!approvalResult.requiresApproval) {
            ...
            logger.logInfo('Nouvel utilisateur enregistré sans approbation', { userId: user.id, email, role });
...
export const login = async (req, res, next) => {
    try {
        ...
        logger.logInfo('Utilisateur connecté avec succès', { userId: user.id, email });
...
export const resetPassword = async (req, res, next) => {
    try {
        ...
        logger.logInfo('Mot de passe réinitialisé', { userId: user.id });
