...
export const ARCH_030_AuditTrailMandatory = {
    id: 'ARCH_030',
...
export const ARCH_031_SingleDecision = {
    id: 'ARCH_031',
...
export const ARCH_032_ProcessContractRequired = {
    id: 'ARCH_032',
    ...
    check(context) {
        const violations = [];
        if (!context.fileName?.endsWith('.process.ts'))
            return violations;
...
export const ARCH_034_NoDirectEntityMutation = {
    id: 'ARCH_034',
...
export const ARCH_036_NoProcessToProcess = {
    id: 'ARCH_036',
...
export const ARCH_038_NoTechnicalEventsInDomain = {
    id: 'ARCH_038',
...
export const ARCH_039_DomainFactImmutable = {
    id: 'ARCH_039',
    ...
    check(context) {
        const violations = [];
        if (!context.fileName?.includes('Fact'))
            return violations;
...
export const ARCH_040_DomainFactPastTense = {
    id: 'ARCH_040',
...
//# sourceMappingURL=ARCH_CRITICAL_RULES.js.map